...
internal val logger: SkipLogger = SkipLogger(subsystem = "muon.skip", category = "MuonSkip")

private typealias AppRootView = MuonSkipRootView
private typealias AppDelegate = MuonSkipAppDelegate
